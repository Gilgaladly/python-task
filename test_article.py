...
from common.commonUtil import assert_varparam, skip_case, sleep_case, execute_sql
...
testxlsx = os.path.join(readexcelpath, "test-yeyun-article.xlsx")
sheetName = ["DemoYeyun"]
...
class Test_demo_multiExcel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.conf_data = ConfigMethod().config_data_method(config_name="data_config_zmk.ini")
